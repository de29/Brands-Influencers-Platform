  ...
  <div class="container clearfix" >
    <div class="people-list" id="people-list">
      ...
      <ul class="list">
        ...
        echo "<div class=\"name\"><a href=\"messageinf.php?value1=$data[id]\"> $data[Name]</a></div>";
        echo "</li>";
        break;
         }
        }
    ...
    <div class="chat">
      <div class="chat-header clearfix">
        <div class="chat-about">
         ...
         $afficher = $_GET['value1'];
          $stmt=$conn->query("SELECT * FROM marque where id= $afficher; " );
      ...
      <form action="sendinf.php?value1=<?php if(!empty($_GET['value1'])) echo $_GET['value1']; ?>  "  method="post">
