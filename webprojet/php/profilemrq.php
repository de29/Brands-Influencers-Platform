...
session_start();
$x = $conn->prepare("select * from marque where Email =?" ) ;
...
<div class="wrapper">
  ...
  <button class="btn"><a href="pagemarque.php">Voir les influenceurs</a></button>
</br></br>
    <button class="btn"><a href="messagemarque.php">voir la messagerie</a></button>
  </br></br>
     <button class="btn"><a href="../html/contratmrq.html">Ajouter contrat</a></button>
  </br></br>
  <button class="btn"><a href="demandemq.php">Demander la suppression du compte</a></button>
</br></br>
    ...
    <div class="right">
      ...
      <div class="projects">
        ...
        <div class="projects">
          ...
          <form action="profileupdatemrq.php" method ="post" enctype="multipart/form-data" onsubmit="return validate()" class="modifierP">
