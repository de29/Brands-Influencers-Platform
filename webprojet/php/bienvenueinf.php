...
<body>
    <nav style="position :fixed;top: 0px;">
        <div class="menu">
          <div class="logo">
            <a href="bienvenueinf.php">ANDI</a>
          </div>
          <ul>
            <li><a href="bienvenueinf.php">Acceuil</a></li>
            <li><a href="pageinfluenceur.php">voir marques</a></li>
            <li><a href="messageinfluenceur.php">messagerie</a></li>
            <li><a href="profile.php">mon profil</a></li><!-- OR PROFILE INF-->
            <li><a href="#"></a></li>
          </ul>
        </div>
      </nav>
    ...
    <?php $query = "SELECT * FROM marque;";
      ...
      <div class="blog-slider__item swiper-slide">
        ...
        <div class="blog-slider__content">
          ...
          <a href="profileNC.php?id=<?php echo $data['id']?>" class="blog-slider__button">VOIR LES DETAILS</a>
        </div>
      </div>
      <?php }?>
...
<ul class="cards">
  <?php 
         $query = "SELECT * FROM partenariat WHERE influenceur='$_SESSION[Name]';";
           $x=$conn->query($query); 
        while ( $data = $x->fetch_assoc()){ 
