...
if(isset($_POST['update'])){
    ...
    $query = "UPDATE marque SET Email='$_POST[Email]' where id=$data[id] ";
...
if(isset($_POST['update1'])){
    ...
    if((($result->num_rows) <1)){
    $query = "UPDATE marque SET Name='$_POST[Name]' WHERE id=$data[id]";
    $query_run = mysqli_query($conn,$query);
...
if(isset($_POST['update2'])){
    ...
    $query = "UPDATE marque SET Password='$Password' WHERE id=$data[id] ";
    $query_run = mysqli_query($conn,$query);
                ...
                if(in_array($extensionUpload,$extensionvalide))
                {
                   ...
                   if($resultat)
                   {
                    if(isset($_POST['update3'])){
                        ...
                        $query = "UPDATE marque SET foto = '$foto'  WHERE id=$data[id] ";
                        $query_run = mysqli_query($conn,$query);
...
if(isset($_POST['update4'])){
    ...
    $query = "UPDATE marque SET ville='$_POST[ville]' WHERE id=$data[id]";
    $query_run = mysqli_query($conn,$query);
...
if(isset($_POST['update5'])){
    ...
    $query = "UPDATE marque SET facebook='$_POST[facebook]' WHERE id=$data[id]";
    $query_run = mysqli_query($conn,$query);
...
if(isset($_POST['update6'])){
    ...
    $query = "UPDATE marque SET instagram='$_POST[instagram]' WHERE id=$data[id]";
    $query_run = mysqli_query($conn,$query);
...
if(isset($_POST['update7'])){
    ...
    $query = "UPDATE marque SET tiktok='$_POST[tiktok]' WHERE id=$data[id]";
    $query_run = mysqli_query($conn,$query);
...
if(isset($_POST['update8'])){
    ...
    $query = "UPDATE marque SET twitter='$_POST[twitter]' WHERE id=$data[id]";
    $query_run = mysqli_query($conn,$query);
...
if(isset($_POST['update9'])){
    ...
    $query = "UPDATE marque SET tel='$_POST[tel]' WHERE id=$data[id]";
    $query_run = mysqli_query($conn,$query);
